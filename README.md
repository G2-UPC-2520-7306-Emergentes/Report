...
|---------|-------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **TB1** | 21/09/2025  | Juan Fabritzzio Pescoran Angulo <br><br> Angelo Marcio Curi Marcelo <br><br> Brenda Lucía Gamio Upiachihua <br><br> Gustavo Esau Huanca Navarro <br><br> Diego Ulises Soto Quispe | Se agregó el contenido completo del **Capítulo 1 (Introducción)**, incluyendo los apartados 1.1 *Startup Profile* (1.1.1 Descripción de la Startup, 1.1.2 Perfiles de integrantes del equipo), 1.2 *Solution Profile* (1.2.1 Antecedentes y problemática, 1.2.2 *Lean UX Process* con sus subapartados 1.2.2.1 *Problem Statements*, 1.2.2.2 *Assumptions*, 1.2.2.3 *Hypothesis Statements*, 1.2.2.4 *Lean UX Canvas*) y 1.3 *Segmentos objetivo*. También se incorporó el **Capítulo 2 (Requirements Elicitation & Analysis)** (competidores, entrevistas, needfinding, lenguaje ubicuo). Asimismo, se completó el **Capítulo 3 (Requirements Specification)** y el **Capítulo 4 (Strategic-Level Software Design)**, incluyendo ADD, Strategic DDD y diagramas arquitectónicos. |
| **TP**  | 10/10/2025  | Juan Fabritzzio Pescoran Angulo <br><br> Angelo Marcio Curi Marcelo <br><br> Brenda Lucía Gamio Upiachihua <br><br> Gustavo Esau Huanca Navarro <br><br> Diego Ulises Soto Quispe | Se realizaron **mejoras al Capítulo 4 (Strategic-Level Software Design)**, optimizando los diagramas y el detalle de drivers. <br><br> Se completó el **Capítulo 5 (Tactical-Level Software Design)**, incorporando Domain Layer, Application Layer, Interface Layer, Infrastructure Layer, Component-Level Diagrams, Code-Level Diagrams, Domain Class Diagrams y Database Design. <br><br> También se desarrolló el **Capítulo 6 (Solution UX Design)**, incluyendo todo el conjunto de Style Guidelines, Information Architecture, Wireframes, Mockups, Wireflows, User Flows y Prototyping. |
| **TB2** | 21/11/2025  | Juan Fabritzzio Pescoran Angulo <br><br> Angelo Marcio Curi Marcelo <br><br> Brenda Lucía Gamio Upiachihua <br><br> Gustavo Esau Huanca Navarro <br><br> Diego Ulises Soto Quispe | Se avanzó el **Capítulo 7 (Product Implementation, Validation & Deployment)** correspondiente a TB2. <br><br> Dentro de esta entrega se desarrolló: <br><br> **• 7.1 Software Configuration Management**: configuración del entorno de desarrollo, estructura de repositorios, gestión de ramas, convenciones de código y lineamientos de despliegue. <br><br> **• 7.2 Sprint 1**: creación del Sprint Planning, Sprint Backlog, evidencias de desarrollo, evidencias de pruebas, ejecución del sprint, documentación de servicios, y evidencias de despliegue del prototipo. <br><br> **• 7.2.7 Software Deployment Evidence**: despliegue funcional del prototipo, integración entre backend, blockchain y aplicativo móvil. <br><br> Con este avance, TB2 deja documentado el ciclo completo del Sprint 1. |
...
En el siguiente cuadro se describen las acciones realizadas y las conclusiones por parte del grupo, que permiten sustentar el logro del ABET – EAC – Student Outcome 3 en la entrega **TB2**.

| Criterio específico | Acciones realizadas | Conclusiones |
|--------------------|--------------------|--------------|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **TB1**<br><br>- **Juan Fabritzzio Pescoran Angulo:** Expuso la presentación de la startup *FoodChain* y la problemática (Capítulo 1), explicando la propuesta de valor y el enfoque de trazabilidad.<br><br>- **Angelo Marcio Curi Marcelo:** Presentó el proceso de entrevistas y análisis de usuarios (Capítulo 2), detallando los hallazgos y su impacto en la definición de requisitos.<br><br>- **Brenda Lucía Gamio Upiachihua:** Explicó el desarrollo de Needfinding y User Personas (Capítulo 2.3), mostrando cómo se identificaron los perfiles y necesidades de los consumidores finales.<br><br>- **Gustavo Esau Huanca Navarro:** Explicó el diseño estratégico de la solución (Capítulo 4), describiendo el EventStorming, los Bounded Contexts y la arquitectura de software propuesta.<br><br>- **Diego Ulises Soto Quispe:** Moderó la presentación global y expuso el Capítulo 3 (Requirements Specification), asegurando coherencia en los mensajes y la integración entre capítulos.<br><br>**TP**<br><br>- **Juan Fabritzzio Pescoran Angulo:** Explicó el Capítulo 5 (*Tactical-Level Software Design*), detallando los componentes de las capas *Domain*, *Application* e *Infrastructure*.<br><br>- **Angelo Marcio Curi Marcelo:** Presentó el desarrollo del *Bounded Context Software Architecture* y los *Component Level Diagrams*, vinculándolos con el diseño estratégico previo.<br><br>- **Brenda Lucía Gamio Upiachihua:** Expuso el Capítulo 6 (*Solution UX Design*), mostrando la estructura visual, los *mock-ups* y las *style guidelines* aplicadas.<br><br>- **Gustavo Esau Huanca Navarro:** Explicó las mejoras aplicadas al Capítulo 4, resaltando la consistencia entre la arquitectura estratégica y táctica.<br><br>- **Diego Ulises Soto Quispe:** Coordinó la exposición final del proyecto y presentó la integración del diseño UX/UI con la arquitectura técnica, asegurando coherencia transversal entre capítulos.<br><br>**TB2**<br><br>- **Juan Fabritzzio Pescoran Angulo:** Presentó la sección de *Software Configuration Management* del Capítulo 7, explicando la configuración del entorno, repositorios y lineamientos técnicos utilizados.<br><br>- **Angelo Marcio Curi Marcelo:** Expuso el *Sprint Planning* y la estructura del Sprint Backlog del Sprint 1, explicando la lógica detrás de la priorización y estimación.<br><br>- **Brenda Lucía Gamio Upiachihua:** Explicó las evidencias de desarrollo y testing del Sprint 1, mostrando capturas, commits y validaciones.<br><br>- **Gustavo Esau Huanca Navarro:** Presentó las evidencias de despliegue del prototipo y la integración con el backend y blockchain.<br><br>- **Diego Ulises Soto Quispe:** Explicó la documentación de servicios y el funcionamiento integrado del sistema durante la demostración del Sprint 1. | **TB1**<br>El equipo demostró una comunicación oral clara y efectiva. Cada integrante expuso su sección de manera precisa y ordenada, adaptando el lenguaje a una audiencia diversa. Se fortalecieron las habilidades de presentación técnica, argumentando decisiones de diseño y garantizando coherencia en todo el proyecto.<br><br>**TP**<br>Durante la exposición final, el equipo mostró dominio técnico y comunicativo, argumentando decisiones arquitectónicas y de diseño visual. La comunicación fue fluida y accesible, demostrando madurez profesional.<br><br>**TB2**<br>En esta entrega el equipo presentó de manera clara los avances del Capítulo 7. Cada integrante presentó las actividades de Sprint 1 con precisión técnica: planificación, desarrollo, pruebas y despliegue. Se evidenció capacidad para comunicar procesos ágiles, explicar evidencias y demostrar el funcionamiento del prototipo. La exposición mostró cohesión, claridad y dominio sobre las actividades de implementación. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **TB1**<br><br>- **Juan Fabritzzio Pescoran Angulo:** Redactó el Capítulo 1 (*Startup Profile*, antecedentes y problemática), presentando de forma ordenada el contexto, las motivaciones y la propuesta de *FoodChain*.<br><br>- **Angelo Marcio Curi Marcelo:** Documentó el diseño, registro y análisis de entrevistas (Capítulo 2.2), empleando un lenguaje técnico preciso y estructurado.<br><br>- **Brenda Lucía Gamio Upiachihua:** Elaboró la sección de *Needfinding* y *User Personas* (Capítulo 2.3), incorporando mapas de empatía y escenarios actuales con redacción clara y consistente.<br><br>- **Gustavo Esau Huanca Navarro:** Redactó el Capítulo 4 (*Strategic-Level Software Design*), incluyendo *EventStorming*, *Context Mapping* y diagramas de arquitectura con terminología especializada.<br><br>- **Diego Ulises Soto Quispe:** Desarrolló el Capítulo 3 (*Requirements Specification*), integrando *To-Be Scenarios*, *User Stories*, *Impact Mapping* y *Product Backlog*, revisando la coherencia general del documento.<br><br>**TP**<br><br>- **Juan Fabritzzio Pescoran Angulo:** Redactó el *Domain Layer* y *Application Layer* (Capítulo 5), estructurando claramente dependencias y responsabilidades.<br><br>- **Angelo Marcio Curi Marcelo:** Documentó los diagramas tácticos y la arquitectura a nivel de componentes y código.<br><br>- **Brenda Lucía Gamio Upiachihua:** Redactó las secciones de *Style Guidelines*, *Information Architecture* y *UX Design* (Capítulo 6), manteniendo uniformidad técnica y narrativa.<br><br>- **Gustavo Esau Huanca Navarro:** Actualizó el Capítulo 4, reforzando la coherencia técnica y visual entre diagramas.<br><br>- **Diego Ulises Soto Quispe:** Integró y revisó la redacción global de los capítulos 5 y 6, asegurando consistencia editorial y técnica.<br><br>**TB2**<br><br>- **Juan Fabritzzio Pescoran Angulo:** Redactó la sección 7.1 (*Software Configuration Management*), documentando entorno, repositorios, ramas y convenciones de desarrollo.<br><br>- **Angelo Marcio Curi Marcelo:** Redactó el *Sprint Planning* y el *Sprint Backlog* del Sprint 1, explicando criterios de estimación y priorización.<br><br>- **Brenda Lucía Gamio Upiachihua:** Documentó las evidencias de desarrollo y testing, incluyendo commits, registros y capturas del Sprint 1.<br><br>- **Gustavo Esau Huanca Navarro:** Redactó las evidencias de despliegue y funcionamiento del prototipo en el entorno configurado.<br><br>- **Diego Ulises Soto Quispe:** Desarrolló la sección de documentación de servicios del Sprint 1, integrando información técnica y evidencias visuales. | **TB1**<br>El equipo alcanzó un alto nivel de redacción técnica, clara y estructurada, permitiendo explicar conceptos complejos de manera comprensible para audiencias especializadas y no técnicas. Se logró uniformidad y coherencia en el estilo documental.<br><br>**TP**<br>La redacción del informe alcanzó un nivel profesional, destacando precisión, claridad y cohesión técnica en los capítulos de diseño táctico y UX. Se evidenció capacidad para comunicar arquitectura y experiencia de usuario mediante documentación sólida y bien estructurada.<br><br>**TB2**<br>La calidad de redacción del Capítulo 7 fue consistente y detallada. El equipo documentó con claridad el proceso de Sprint 1, la configuración del entorno, las evidencias de desarrollo, pruebas, servicios y despliegue. La escritura fue precisa, técnica y alineada con prácticas de documentación ágil y de ingeniería de software. |
