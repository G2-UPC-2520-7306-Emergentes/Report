...
|:-----------------------|:-------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Lot**                | Lote de Origen           | Unidad fundamental de trazabilidad. Conjunto de productos con origen, fecha de producción y atributos comunes.                                                                                                                     |
| **Lot Status**         | Estado del Lote          | Condición actual del Lote: **Active** (Abierto a registros), **Cancelled** (Anulado por error), **Closed** (Finalizado, no acepta más eventos).                                                                                    |
...
| **Blockchain Anchor**  | Anclaje en Blockchain    | Proceso de escribir el **Hash del Evento** en el Smart Contract de la red Polygon. No almacena datos; solo genera la prueba de inmutabilidad.                                                                                      |
...
| **Consumer Query**     | Consulta de Trazabilidad | Acción pública, no autenticada, realizada por el **Consumer** al escanear el **Identificador QR** para visualizar el **Historial de Trazabilidad**.                                                                                |
